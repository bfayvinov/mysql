...
Handshake.prototype['HandshakeInitializationPacket'] = function(packet) {
  ...
  if (this._config.ssl) {
    ...
    if (this._config.connectAttributes) {
      this._config.clientFlags |= ClientConstants.CLIENT_CONNECT_ATTRS;
    }
...
Handshake.prototype._sendCredentials = function() {
  ...
  if (this._config.connectAttributes) {
    authPacketParams.connectAttributes = this._config.connectAttributes;
  }
  this.emit('packet', new Packets.ClientAuthenticationPacket(authPacketParams));
};
